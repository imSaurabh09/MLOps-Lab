...
print("Loading training data... ###--Testing CI/CD Trial 1--### ")
...
print("Training the model... ###--Testing CI/CD Trial 1--###")
# Randomly pic alpha
...
print("Evaluate the model... ###--Testing CI/CD Trial 1--###")
...
print("Exporting the model as pickle file... ###--Testing CI/CD Trial 1--### ")
...
print("Uploading the model into run artifacts... ###--Testing CI/CD Trial 1--### ")
